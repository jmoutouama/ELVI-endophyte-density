...
parameters {
  ...
  vector[n_species] bclim2_spk;  
  vector[n_species] bendoclim2_spk;
...
transformed parameters {
  ...
  for(ispk in 1:n_spk){
    predSPK[ispk] = b0_spk[species_spk[ispk]] + 
                ...
                bclim2_spk[species_spk[ispk]] * pow(clim_spk[ispk],2) +  
                bendoclim2_spk[species_spk[ispk]] * endo_spk[ispk] * pow(clim_spk[ispk],2) + 
                //random effects
