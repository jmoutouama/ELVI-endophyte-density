...
parameters {
  ...
  vector[n_species] bclim2_s;  
  vector[n_species] bendoclim2_s;
  //random effects
...
transformed parameters {
  ...
  for(isurv in 1:n_s){
    predS[isurv] = b0_s[species_s[isurv]] + 
                ...
                bclim2_s[species_s[isurv]] * pow(clim_s[isurv],2) +  
                bendoclim2_s[species_s[isurv]] * endo_s[isurv] * pow(clim_s[isurv],2) + 
                //random effects
