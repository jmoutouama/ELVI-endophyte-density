...
# Assuming your observed data is stored in `observed_data`
...
ggplot(cred_intervals, aes(x = clim, y = median, color = factor(endo))) +
  ...
  geom_point(data = observed_data, aes(x = clim, y = y, color = factor(endo)), size = 3) +  # Observed data points
  facet_grid(species ~ herb, scales = "free_y", labeller = labeller(species = c("1" = "AGHY", "2" = "ELVI", "3" = "POAU"),herb_s = c("0" = "Unfenced", "1" = "Fenced"))) +
  labs(
    x = "Precipitation (mm)",
